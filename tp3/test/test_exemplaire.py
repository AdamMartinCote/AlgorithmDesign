...
class TestExamplaire(TestCase):
    def test_exemplaire_created(self):
        ...
        self.assertEqual(base_val_ref, exemplaire.baseQuality)

        # TODO implement
        # self.assertEqual(mat_0_3, exemplaire.synergyMatrix[0][3])
        # self.assertEqual(mat_99_99, exemplaire.synergyMatrix[99][99])
        # self.assertEqual(mat_98_97, exemplaire.synergyMatrix[98][97])
